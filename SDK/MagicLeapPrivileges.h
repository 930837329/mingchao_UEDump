...
{ 
public:
	// bool RequestPrivilegeAsync(EMagicLeapPrivilege Privilege, FDelegateProperty& ResultDelegate);                            // [0x21f7620] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// bool RequestPrivilege(EMagicLeapPrivilege Privilege);                                                                    // [0x21f75a0] Final|Native|Static|Public|BlueprintCallable 
	// bool CheckPrivilege(EMagicLeapPrivilege Privilege);                                                                      // [0x21f75a0] Final|Native|Static|Public|BlueprintCallable 
};
