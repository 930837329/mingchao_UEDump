...
/// Size: 0x0090 (144 bytes) (0x000328 - 0x0003B8) align 8 pad: 0x0000
...
public:
	...
	SDK_UNDEFINED(16,405) /* FMulticastInlineDelegate */ __um(ReceiveMoveCompleted);                               // 0x03A0   (0x0010)  
	unsigned char                                      UnknownData02_7[0x8];                                       // 0x03B0   (0x0008)  MISSED
	// bool UseBlackboard(class UBlackboardData* BlackboardAsset, class UBlackboardComponent*& BlackboardComponent);            // [0x49d7af0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// void UnclaimTaskResource(class UClass* ResourceClass);                                                                   // [0x49d78a0] Final|Native|Public|BlueprintCallable 
	// void SetPathFollowingComponent(class UPathFollowingComponent* NewPFComponent);                                           // [0x49d7390] Final|Native|Public|BlueprintCallable 
	// void SetMoveBlockDetection(bool bEnable);                                                                                // [0x49d7300] Final|Native|Public|BlueprintCallable 
	// bool RunBehaviorTree(class UBehaviorTree* BTAsset);                                                                      // [0x49d7100] Native|Public|BlueprintCallable 
	// void OnUsingBlackBoard(class UBlackboardComponent* BlackboardComp, class UBlackboardData* BlackboardAsset);              // [0x25a7960] Event|Protected|BlueprintEvent 
	// void OnGameplayTaskResourcesClaimed(FGameplayResourceSet NewlyClaimed, FGameplayResourceSet FreshlyReleased);            // [0x49d6dc0] Native|Public        
	// TEnumAsByte<EPathFollowingRequestResult> MoveToLocation(FVector& Dest, float AcceptanceRadius, bool bStopOnOverlap, bool bUsePathfinding, bool bProjectDestinationToNavigation, bool bCanStrafe, class UClass* FilterClass, bool bAllowPartialPath); // [0x49d6b30] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// TEnumAsByte<EPathFollowingRequestResult> MoveToActor(class AActor* Goal, float AcceptanceRadius, bool bStopOnOverlap, bool bUsePathfinding, bool bCanStrafe, class UClass* FilterClass, bool bAllowPartialPath); // [0x49d68f0] Final|Native|Public|BlueprintCallable 
	// void K2_SetFocus(class AActor* NewFocus);                                                                                // [0x49d6750] Final|Native|Public|BlueprintCallable 
	// void K2_SetFocalPoint(FVector FP);                                                                                       // [0x49d66c0] Final|Native|Public|HasDefaults|BlueprintCallable 
	// void K2_ClearFocus();                                                                                                    // [0x49d66a0] Final|Native|Public|BlueprintCallable 
	// bool HasPartialPath();                                                                                                   // [0x49d64c0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// class UPathFollowingComponent* GetPathFollowingComponent();                                                              // [0x49d6210] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// TEnumAsByte<EPathFollowingStatus> GetMoveStatus();                                                                       // [0x49d6150] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// FVector GetImmediateMoveDestination();                                                                                   // [0x49d6020] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// class AActor* GetFocusActor();                                                                                           // [0x49d5ff0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// FVector GetFocalPointOnActor(class AActor* Actor);                                                                       // [0x49d5f40] Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// FVector GetFocalPoint();                                                                                                 // [0x49d5f00] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// class UAIPerceptionComponent* GetAIPerceptionComponent();                                                                // [0x49d5a60] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// void ClaimTaskResource(class UClass* ResourceClass);                                                                     // [0x49d5740] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	SDK_UNDEFINED(16,407) /* FMulticastInlineDelegate */ __um(OnFail);                                             // 0x0040   (0x0010)  
	unsigned char                                      UnknownData00_7[0x20];                                      // 0x0050   (0x0020)  MISSED
	// void OnMoveCompleted(FAIRequestID RequestID, TEnumAsByte<EPathFollowingResult> MovementResult);                          // [0x49d6e90] Final|Native|Public  
};
...
{ 
public:
	// void UnlockAIResourcesWithAnimation(class UAnimInstance* AnimInstance, bool bUnlockMovement, bool UnlockAILogic);        // [0x49d7930] Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable 
	// class APawn* SpawnAIFromClass(class UObject* WorldContextObject, class UClass* PawnClass, class UBehaviorTree* BehaviorTree, FVector Location, FRotator Rotation, bool bNoCollisionFail, class AActor* Owner); // [0x49d7670] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	// void SimpleMoveToLocation(class AController* Controller, FVector& Goal);                                                 // [0x49d75b0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// void SimpleMoveToActor(class AController* Controller, class AActor* Goal);                                               // [0x49d74f0] Final|Native|Static|Public|BlueprintCallable 
	// void SendAIMessage(class APawn* Target, FName Message, class UObject* MessageSource, bool bSuccess);                     // [0x49d71a0] Final|Native|Static|Public|BlueprintCallable 
	// void LockAIResourcesWithAnimation(class UAnimInstance* AnimInstance, bool bLockMovement, bool LockAILogic);              // [0x49d67e0] Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable 
	// bool IsValidAIRotation(FRotator Rotation);                                                                               // [0x49d6610] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// bool IsValidAILocation(FVector Location);                                                                                // [0x49d6580] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// bool IsValidAIDirection(FVector DirectionVector);                                                                        // [0x49d64f0] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// int32_t GetNextNavLinkIndex(class AController* Controller);                                                              // [0x49d6180] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// TArray<FVector> GetCurrentPathPoints(class AController* Controller);                                                     // [0x49d5d30] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// int32_t GetCurrentPathIndex(class AController* Controller);                                                              // [0x49d5ca0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// class UNavigationPath* GetCurrentPath(class AController* Controller);                                                    // [0x49d5c10] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// class UBlackboardComponent* GetBlackboard(class AActor* Target);                                                         // [0x49d5b80] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// class AAIController* GetAIController(class AActor* ControlledActor);                                                     // [0x49d59d0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// class UAIAsyncTaskBlueprintProxy* CreateMoveToProxyObject(class UObject* WorldContextObject, class APawn* Pawn, FVector Destination, class AActor* TargetActor, float AcceptanceRadius, bool bStopOnOverlap); // [0x49d57d0] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
};
...
/// Size: 0x00E0 (224 bytes) (0x0000C0 - 0x0001A0) align 8 pad: 0x0000
...
public:
	...
	SDK_UNDEFINED(16,408) /* FMulticastInlineDelegate */ __um(OnPerceptionUpdated);                                // 0x0170   (0x0010)  
	SDK_UNDEFINED(16,409) /* FMulticastInlineDelegate */ __um(OnTargetPerceptionUpdated);                          // 0x0180   (0x0010)  
	SDK_UNDEFINED(16,410) /* FMulticastInlineDelegate */ __um(OnTargetPerceptionInfoUpdated);                      // 0x0190   (0x0010)  
	// void SetSenseEnabled(class UClass* SenseClass, bool bEnable);                                                            // [0x49d7420] Final|Native|Public|BlueprintCallable 
	// void RequestStimuliListenerUpdate();                                                                                     // [0x49d70e0] Final|Native|Public|BlueprintCallable 
	// void OnOwnerEndPlay(class AActor* Actor, TEnumAsByte<EEndPlayReason> EndPlayReason);                                     // [0x49d6f60] Final|Native|Public  
	// void GetPerceivedHostileActorsBySense(class UClass* SenseToUse, TArray<AActor*>& OutActors);                             // [0x49d63d0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// void GetPerceivedHostileActors(TArray<AActor*>& OutActors);                                                              // [0x49d6320] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// void GetPerceivedActors(class UClass* SenseToUse, TArray<AActor*>& OutActors);                                           // [0x49d6230] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// void GetKnownPerceivedActors(class UClass* SenseToUse, TArray<AActor*>& OutActors);                                      // [0x49d6060] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// void GetCurrentlyPerceivedActors(class UClass* SenseToUse, TArray<AActor*>& OutActors);                                  // [0x49d5e10] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// bool GetActorsPerception(class AActor* Actor, FActorPerceptionBlueprintInfo& Info);                                      // [0x49d5a80] Final|Native|Public|HasOutParms|BlueprintCallable 
	// void ForgetAll();                                                                                                        // [0x49d59b0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void UnregisterFromSense(class UClass* SenseClass);                                                                      // [0x49d7a60] Final|Native|Public|BlueprintCallable 
	// void UnregisterFromPerceptionSystem();                                                                                   // [0x49d7a40] Final|Native|Public|BlueprintCallable 
	// void RegisterWithPerceptionSystem();                                                                                     // [0x49d70c0] Final|Native|Public|BlueprintCallable 
	// void RegisterForSense(class UClass* SenseClass);                                                                         // [0x49d7030] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void ReportPerceptionEvent(class UObject* WorldContextObject, class UAISenseEvent* PerceptionEvent);                     // [0x49dc3a0] Final|Native|Static|Public|BlueprintCallable 
	// void ReportEvent(class UAISenseEvent* PerceptionEvent);                                                                  // [0x49dc120] Final|Native|Public|BlueprintCallable 
	// bool RegisterPerceptionStimuliSource(class UObject* WorldContextObject, class UClass* Sense, class AActor* Target);      // [0x49dbe30] Final|Native|Static|Public|BlueprintCallable 
	// void OnPerceptionStimuliSourceEndPlay(class AActor* Actor, TEnumAsByte<EEndPlayReason> EndPlayReason);                   // [0x49dbd60] Final|Native|Protected 
	// class UClass* GetSenseClassForStimulus(class UObject* WorldContextObject, FAIStimulus& Stimulus);                        // [0x49dbc10] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// float OnUpdate(TArray<UAISenseEvent*>& EventsToProcess);                                                                 // [0x25a7960] Event|Public|HasOutParms|BlueprintEvent 
	// void OnListenerUpdated(class AActor* ActorListener, class UAIPerceptionComponent* PerceptionComponent);                  // [0x25a7960] Event|Public|BlueprintEvent 
	// void OnListenerUnregistered(class AActor* ActorListener, class UAIPerceptionComponent* PerceptionComponent);             // [0x25a7960] Event|Public|BlueprintEvent 
	// void OnListenerRegistered(class AActor* ActorListener, class UAIPerceptionComponent* PerceptionComponent);               // [0x25a7960] Event|Public|BlueprintEvent 
	// void K2_OnNewPawn(class APawn* NewPawn);                                                                                 // [0x25a7960] Event|Public|BlueprintEvent 
	// void GetAllListenerComponents(TArray<UAIPerceptionComponent*>& ListenerComponents);                                      // [0x49dbb60] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// void GetAllListenerActors(TArray<AActor*>& ListenerActors);                                                              // [0x49dbab0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void ReportDamageEvent(class UObject* WorldContextObject, class AActor* DamagedActor, class AActor* Instigator, float DamageAmount, FVector EventLocation, FVector HitLocation); // [0x49dbf30] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
};
...
/// Size: 0x0068 (104 bytes) (0x000090 - 0x0000F8) align 8 pad: 0x0000
class UAISense_Hearing : public UAISense
{ 
public:
	TArray<FAINoiseEvent>                              NoiseEvents;                                                // 0x0090   (0x0010)  
	float                                              SpeedOfSoundSq;                                             // 0x00A0   (0x0004)  
	unsigned char                                      UnknownData00_7[0x54];                                      // 0x00A4   (0x0054)  MISSED
	// void ReportNoiseEvent(class UObject* WorldContextObject, FVector NoiseLocation, float Loudness, class AActor* Instigator, float MaxRange, FName Tag); // [0x49dc1b0] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void RequestPawnPredictionEvent(class APawn* Requestor, class AActor* PredictedActor, float PredictionTime);             // [0x49dc570] Final|Native|Static|Public|BlueprintCallable 
	// void RequestControllerPredictionEvent(class AAIController* Requestor, class AActor* PredictedActor, float PredictionTime); // [0x49dc460] Final|Native|Static|Public|BlueprintCallable 
};

/// Class /Script/AIModule.AISense_Sight
/// Size: 0x00F0 (240 bytes) (0x000090 - 0x000180) align 8 pad: 0x0000
class UAISense_Sight : public UAISense
{ 
public:
	unsigned char                                      UnknownData00_3[0xC8];                                      // 0x0090   (0x00C8)  MISSED
...
{ 
public:
	FAIDamageEvent                                     Event;                                                      // 0x0030   (0x0030)  
};
...
/// Size: 0x00E8 (232 bytes) (0x000070 - 0x000158) align 8 pad: 0x0000
...
public:
	...
	TEnumAsByte<ECollisionChannel>                     DefaultSightCollisionChannel;                               // 0x00C4   (0x0001)  
	...
	unsigned char                                      UnknownData01_7[0x58];                                      // 0x0100   (0x0058)  MISSED
	// void AILoggingVerbose();                                                                                                 // [0x36333c0] Exec|Native|Public   
	// void AIIgnorePlayers();                                                                                                  // [0xc4ccd0] Exec|Native|Public   
};
...
public:
	...
	// class UAITask_RunEQS* RunEQS(class AAIController* Controller, class UEnvQuery* QueryTemplate);                           // [0x49dc680] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void StopLogic(FString reason);                                                                                          // [0x49e1af0] Native|Public|BlueprintCallable 
	// void StartLogic();                                                                                                       // [0xbe0a80] Native|Public|BlueprintCallable 
	// void RestartLogic();                                                                                                     // [0x49e0ff0] Native|Public|BlueprintCallable 
	// bool IsRunning();                                                                                                        // [0x49e0f10] Native|Public|BlueprintCallable|BlueprintPure|Const 
	// bool IsPaused();                                                                                                         // [0x49e0ee0] Native|Public|BlueprintCallable|BlueprintPure|Const 
};

/// Class /Script/AIModule.BehaviorTreeComponent
/// Size: 0x01F0 (496 bytes) (0x000118 - 0x000308) align 8 pad: 0x0000
...
public:
	...
	unsigned char                                      UnknownData02_7[0x78];                                      // 0x0290   (0x0078)  MISSED
	// void SetDynamicSubtree(FGameplayTag InjectTag, class UBehaviorTree* BehaviorAsset);                                      // [0x49e1010] Native|Public|BlueprintCallable 
	// float GetTagCooldownEndTime(FGameplayTag CooldownTag);                                                                   // [0x49e0680] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// void AddCooldownTagDuration(FGameplayTag CooldownTag, float CooldownDuration, bool bAddToExistingDuration);              // [0x49e0280] Final|Native|Public|BlueprintCallable 
};
...
{ 
	...
	unsigned char                                      UnknownData00_7[0x58];                                      // 0x0010   (0x0058)  MISSED
};
...
public:
	...
	SDK_UNDEFINED(80,413) /* TMap<UBehaviorTree*, FBehaviorTreeTemplateInfo> */ __um(LoadedTemplateMap);           // 0x0048   (0x0050)  
	unsigned char                                      UnknownData01_6[0x50];                                      // 0x0098   (0x0050)  MISSED
	TArray<class UBehaviorTreeComponent*>              ActiveComponents;                                           // 0x00E8   (0x0010)  
};
...
{ 
public:
	// class UBlackboardData* GetBlackboardAsset();                                                                             // [0x49e0450] Native|Public|BlueprintCallable|BlueprintPure|Const 
};

/// Class /Script/AIModule.BlackboardComponent
/// Size: 0x0108 (264 bytes) (0x0000C0 - 0x0001C8) align 8 pad: 0x0000
...
public:
	...
	// void SetValueAsVector(FName& KeyName, FVector VectorValue);                                                              // [0x49e19f0] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// void SetValueAsString(FName& KeyName, FString StringValue);                                                              // [0x49e18a0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// void SetValueAsRotator(FName& KeyName, FRotator VectorValue);                                                            // [0x49e17a0] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// void SetValueAsObject(FName& KeyName, class UObject* ObjectValue);                                                       // [0x49e16b0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// void SetValueAsName(FName& KeyName, FName NameValue);                                                                    // [0x49e15b0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// void SetValueAsInt(FName& KeyName, int32_t IntValue);                                                                    // [0x49e14c0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// void SetValueAsFloat(FName& KeyName, float FloatValue);                                                                  // [0x49e13d0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// void SetValueAsEnum(FName& KeyName, char EnumValue);                                                                     // [0x49e12e0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// void SetValueAsClass(FName& KeyName, class UClass* ClassValue);                                                          // [0x49e11f0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// void SetValueAsBool(FName& KeyName, bool BoolValue);                                                                     // [0x49e1100] Final|Native|Public|HasOutParms|BlueprintCallable 
	// bool IsVectorValueSet(FName& KeyName);                                                                                   // [0x49e0f40] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// FVector GetValueAsVector(FName& KeyName);                                                                                // [0x49e0dc0] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// FString GetValueAsString(FName& KeyName);                                                                                // [0x49e0cd0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// FRotator GetValueAsRotator(FName& KeyName);                                                                              // [0x49e0c10] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// class UObject* GetValueAsObject(FName& KeyName);                                                                         // [0x49e0b60] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// FName GetValueAsName(FName& KeyName);                                                                                    // [0x49e0aa0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// int32_t GetValueAsInt(FName& KeyName);                                                                                   // [0x49e09f0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// float GetValueAsFloat(FName& KeyName);                                                                                   // [0x49e0940] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// char GetValueAsEnum(FName& KeyName);                                                                                     // [0x49e0890] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// class UClass* GetValueAsClass(FName& KeyName);                                                                           // [0x49e07e0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// bool GetValueAsBool(FName& KeyName);                                                                                     // [0x49e0730] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// bool GetRotationFromEntry(FName& KeyName, FRotator& ResultRotation);                                                     // [0x49e0580] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// bool GetLocationFromEntry(FName& KeyName, FVector& ResultLocation);                                                      // [0x49e0480] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// void ClearValue(FName& KeyName);                                                                                         // [0x49e03b0] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
/// Size: 0x0030 (48 bytes) (0x0000A0 - 0x0000D0) align 8 pad: 0x0000
class UBTDecorator_Blackboard : public UBTDecorator_BlackboardBase
{ 
public:
	int32_t                                            IntValue;                                                   // 0x00A0   (0x0004)  
	float                                              FloatValue;                                                 // 0x00A4   (0x0004)  
	FString                                            StringValue;                                                // 0x00A8   (0x0010)  
	FString                                            CachedDescription;                                          // 0x00B8   (0x0010)  
	char                                               OperationType;                                              // 0x00C8   (0x0001)  
	TEnumAsByte<EBTBlackboardRestart>                  NotifyObserver;                                             // 0x00C9   (0x0001)  
...
public:
	...
	// void ReceiveTickAI(class AAIController* OwnerController, class APawn* ControlledPawn, float DeltaSeconds);               // [0x25a7960] Event|Protected|BlueprintEvent 
	// void ReceiveTick(class AActor* OwnerActor, float DeltaSeconds);                                                          // [0x25a7960] Event|Protected|BlueprintEvent 
	// void ReceiveObserverDeactivatedAI(class AAIController* OwnerController, class APawn* ControlledPawn);                    // [0x25a7960] Event|Protected|BlueprintEvent 
	// void ReceiveObserverDeactivated(class AActor* OwnerActor);                                                               // [0x25a7960] Event|Protected|BlueprintEvent 
	// void ReceiveObserverActivatedAI(class AAIController* OwnerController, class APawn* ControlledPawn);                      // [0x25a7960] Event|Protected|BlueprintEvent 
	// void ReceiveObserverActivated(class AActor* OwnerActor);                                                                 // [0x25a7960] Event|Protected|BlueprintEvent 
	// void ReceiveExecutionStartAI(class AAIController* OwnerController, class APawn* ControlledPawn);                         // [0x25a7960] Event|Protected|BlueprintEvent 
	// void ReceiveExecutionStart(class AActor* OwnerActor);                                                                    // [0x25a7960] Event|Protected|BlueprintEvent 
	// void ReceiveExecutionFinishAI(class AAIController* OwnerController, class APawn* ControlledPawn, TEnumAsByte<EBTNodeResult> NodeResult); // [0x25a7960] Event|Protected|BlueprintEvent 
	// void ReceiveExecutionFinish(class AActor* OwnerActor, TEnumAsByte<EBTNodeResult> NodeResult);                            // [0x25a7960] Event|Protected|BlueprintEvent 
	// bool PerformConditionCheckAI(class AAIController* OwnerController, class APawn* ControlledPawn);                         // [0x25a7960] Event|Protected|BlueprintEvent 
	// bool PerformConditionCheck(class AActor* OwnerActor);                                                                    // [0x25a7960] Event|Protected|BlueprintEvent 
	// bool IsDecoratorObserverActive();                                                                                        // [0x49e0eb0] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// bool IsDecoratorExecutionActive();                                                                                       // [0x49e0e80] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	FString                                            CachedDescription;                                          // 0x00C8   (0x0010)  
};
...
public:
	...
	TEnumAsByte<EPathExistanceQueryType>               PathQueryType;                                              // 0x00D4   (0x0001)  
...
public:
	...
	unsigned char                                      UnknownData02_7[0x3];                                       // 0x00ED   (0x0003)  MISSED
};
...
{ 
public:
	// void StopUsingExternalEvent(class UBTNode* NodeOwner);                                                                   // [0xfe37d0] Final|Native|Static|Public|BlueprintCallable 
	// void StartUsingExternalEvent(class UBTNode* NodeOwner, class AActor* OwningActor);                                       // [0x4767270] Final|Native|Static|Public|BlueprintCallable 
	// void SetBlackboardValueAsVector(class UBTNode* NodeOwner, FBlackboardKeySelector& Key, FVector Value);                   // [0x49e61a0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// void SetBlackboardValueAsString(class UBTNode* NodeOwner, FBlackboardKeySelector& Key, FString Value);                   // [0x49e6010] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// void SetBlackboardValueAsRotator(class UBTNode* NodeOwner, FBlackboardKeySelector& Key, FRotator Value);                 // [0x49e5ec0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// void SetBlackboardValueAsObject(class UBTNode* NodeOwner, FBlackboardKeySelector& Key, class UObject* Value);            // [0x49e5d80] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// void SetBlackboardValueAsName(class UBTNode* NodeOwner, FBlackboardKeySelector& Key, FName Value);                       // [0x49e5c30] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// void SetBlackboardValueAsInt(class UBTNode* NodeOwner, FBlackboardKeySelector& Key, int32_t Value);                      // [0x49e5af0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// void SetBlackboardValueAsFloat(class UBTNode* NodeOwner, FBlackboardKeySelector& Key, float Value);                      // [0x49e59a0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// void SetBlackboardValueAsEnum(class UBTNode* NodeOwner, FBlackboardKeySelector& Key, char Value);                        // [0x49e5850] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// void SetBlackboardValueAsClass(class UBTNode* NodeOwner, FBlackboardKeySelector& Key, class UClass* Value);              // [0x49e5710] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// void SetBlackboardValueAsBool(class UBTNode* NodeOwner, FBlackboardKeySelector& Key, bool Value);                        // [0x49e55c0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// class UBlackboardComponent* GetOwnersBlackboard(class UBTNode* NodeOwner);                                               // [0x49e54a0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// class UBehaviorTreeComponent* GetOwnerComponent(class UBTNode* NodeOwner);                                               // [0x49e5410] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// FVector GetBlackboardValueAsVector(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                               // [0x49e52f0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// FString GetBlackboardValueAsString(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                               // [0x49e51a0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// FRotator GetBlackboardValueAsRotator(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                             // [0x49e5080] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// class UObject* GetBlackboardValueAsObject(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                        // [0x49e4f80] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// FName GetBlackboardValueAsName(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                                   // [0x49e4e60] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// int32_t GetBlackboardValueAsInt(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                                  // [0x49e4d60] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// float GetBlackboardValueAsFloat(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                                  // [0x49e4c60] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// char GetBlackboardValueAsEnum(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                                    // [0x49e4b60] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// class UClass* GetBlackboardValueAsClass(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                          // [0x49e4a60] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// bool GetBlackboardValueAsBool(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                                    // [0x49e4960] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// class AActor* GetBlackboardValueAsActor(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                          // [0x49e4860] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// void ClearBlackboardValueAsVector(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                                // [0x49e46c0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// void ClearBlackboardValue(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                                        // [0x49e46c0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
/// Size: 0x0030 (48 bytes) (0x000078 - 0x0000A8) align 8 pad: 0x0000
...
public:
	...
	// void ReceiveTickAI(class AAIController* OwnerController, class APawn* ControlledPawn, float DeltaSeconds);               // [0x25a7960] Event|Protected|BlueprintEvent 
	// void ReceiveTick(class AActor* OwnerActor, float DeltaSeconds);                                                          // [0x25a7960] Event|Protected|BlueprintEvent 
	// void ReceiveSearchStartAI(class AAIController* OwnerController, class APawn* ControlledPawn);                            // [0x25a7960] Event|Protected|BlueprintEvent 
	// void ReceiveSearchStart(class AActor* OwnerActor);                                                                       // [0x25a7960] Event|Protected|BlueprintEvent 
	// void ReceiveDeactivationAI(class AAIController* OwnerController, class APawn* ControlledPawn);                           // [0x25a7960] Event|Protected|BlueprintEvent 
	// void ReceiveDeactivation(class AActor* OwnerActor);                                                                      // [0x25a7960] Event|Protected|BlueprintEvent 
	// void ReceiveActivationAI(class AAIController* OwnerController, class APawn* ControlledPawn);                             // [0x25a7960] Event|Protected|BlueprintEvent 
	// void ReceiveActivation(class AActor* OwnerActor);                                                                        // [0x25a7960] Event|Protected|BlueprintEvent 
	// bool IsServiceActive();                                                                                                  // [0x49e5530] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
{ 
	...
	TEnumAsByte<EEnvQueryRunMode>                      RunMode;                                                    // 0x0048   (0x0001)  
...
/// Size: 0x0060 (96 bytes) (0x0000A8 - 0x000108) align 8 pad: 0x0000
...
public:
	...
	// void SetFinishOnMessageWithId(FName MessageName, int32_t RequestID);                                                     // [0x49e6390] Final|Native|Protected|BlueprintCallable 
	// void SetFinishOnMessage(FName MessageName);                                                                              // [0x49e62f0] Final|Native|Protected|BlueprintCallable 
	// void ReceiveTickAI(class AAIController* OwnerController, class APawn* ControlledPawn, float DeltaSeconds);               // [0x25a7960] Event|Protected|BlueprintEvent 
	// void ReceiveTick(class AActor* OwnerActor, float DeltaSeconds);                                                          // [0x25a7960] Event|Protected|BlueprintEvent 
	// void ReceiveExecuteAI(class AAIController* OwnerController, class APawn* ControlledPawn);                                // [0x25a7960] Event|Protected|BlueprintEvent 
	// void ReceiveExecute(class AActor* OwnerActor);                                                                           // [0x25a7960] Event|Protected|BlueprintEvent 
	// void ReceiveAbortAI(class AAIController* OwnerController, class APawn* ControlledPawn);                                  // [0x25a7960] Event|Protected|BlueprintEvent 
	// void ReceiveAbort(class AActor* OwnerActor);                                                                             // [0x25a7960] Event|Protected|BlueprintEvent 
	// bool IsTaskExecuting();                                                                                                  // [0x49e5590] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// bool IsTaskAborting();                                                                                                   // [0x49e5560] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// void FinishExecute(bool bSuccess);                                                                                       // [0x49e47d0] Final|Native|Protected|BlueprintCallable 
	// void FinishAbort();                                                                                                      // [0x49e47b0] Final|Native|Protected|BlueprintCallable 
};
...
/// Size: 0x00C8 (200 bytes) (0x0000A8 - 0x000170) align 8 pad: 0x0000
...
public:
	...
	TEnumAsByte<EEnvQueryRunMode>                      RunMode;                                                    // 0x00D0   (0x0001)  
	...
	unsigned char                                      UnknownData02_7[0x10];                                      // 0x0160   (0x0010)  MISSED
};
...
/// Size: 0x01A0 (416 bytes) (0x0000C0 - 0x000260) align 8 pad: 0x0000
...
public:
	...
	// void OnNavDataRegistered(class ANavigationData* NavData);                                                                // [0x49f0ab0] Final|Native|Protected 
	// void OnActorBump(class AActor* SelfActor, class AActor* OtherActor, FVector NormalImpulse, FHitResult& Hit);             // [0x49f0910] Native|Public|HasOutParms|HasDefaults 
	// FVector GetPathDestination();                                                                                            // [0x49f0520] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// TEnumAsByte<EPathFollowingAction> GetPathActionType();                                                                   // [0x49f04f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};

/// Class /Script/AIModule.CrowdFollowingComponent
/// Size: 0x0048 (72 bytes) (0x000260 - 0x0002A8) align 8 pad: 0x0000
class UCrowdFollowingComponent : public UPathFollowingComponent
{ 
public:
	unsigned char                                      UnknownData00_3[0x18];                                      // 0x0260   (0x0018)  MISSED
	FVector                                            CrowdAgentMoveDirection;                                    // 0x0278   (0x000C)  
	unsigned char                                      UnknownData01_7[0x24];                                      // 0x0284   (0x0024)  MISSED
	// void SuspendCrowdSteering(bool bSuspend);                                                                                // [0x49e9920] Native|Public|BlueprintCallable 
};
...
public:
	unsigned char                                      UnknownData00_1[0x8];                                       // 0x0030   (0x0008)  MISSED
	// void ProvideSingleLocation(class UObject* QuerierObject, class AActor* QuerierActor, FVector& ResultingLocation);        // [0x25a7960] Event|Public|HasOutParms|HasDefaults|BlueprintEvent|Const 
	// void ProvideSingleActor(class UObject* QuerierObject, class AActor* QuerierActor, class AActor*& ResultingActor);        // [0x25a7960] Event|Public|HasOutParms|BlueprintEvent|Const 
	// void ProvideLocationsSet(class UObject* QuerierObject, class AActor* QuerierActor, TArray<FVector>& ResultingLocationSet); // [0x25a7960] Event|Public|HasOutParms|BlueprintEvent|Const 
	// void ProvideActorsSet(class UObject* QuerierObject, class AActor* QuerierActor, TArray<AActor*>& ResultingActorsSet);    // [0x25a7960] Event|Public|HasOutParms|BlueprintEvent|Const 
};
...
/// Size: 0x0090 (144 bytes) (0x000058 - 0x0000E8) align 8 pad: 0x0000
...
public:
	...
	// class UObject* GetQuerier();                                                                                             // [0x49e98f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// void DoItemGeneration(TArray<FVector>& ContextLocations);                                                                // [0x25a7960] Event|Public|HasOutParms|BlueprintEvent|Const 
	// void AddGeneratedVector(FVector GeneratedVector);                                                                        // [0x49e9860] Final|Native|Public|HasDefaults|BlueprintCallable|Const 
	// void AddGeneratedActor(class AActor* GeneratedActor);                                                                    // [0x49e97d0] Final|Native|Public|BlueprintCallable|Const 
};

/// Class /Script/AIModule.EnvQueryGenerator_Composite
/// Size: 0x0020 (32 bytes) (0x000058 - 0x000078) align 8 pad: 0x0000
...
/// Size: 0x0110 (272 bytes) (0x000088 - 0x000198) align 8 pad: 0x0000
...
public:
	...
	unsigned char                                      UnknownData00_7[0x7];                                       // 0x0191   (0x0007)  MISSED
};
...
/// Size: 0x0178 (376 bytes) (0x000088 - 0x000200) align 8 pad: 0x0000
...
public:
	...
	unsigned char                                      UnknownData01_7[0x7];                                       // 0x01F9   (0x0007)  MISSED
};

/// Class /Script/AIModule.EnvQueryGenerator_OnCircle
/// Size: 0x01B8 (440 bytes) (0x000088 - 0x000240) align 8 pad: 0x0000
...
public:
	...
	unsigned char                                      UnknownData03_7[0x7];                                       // 0x0239   (0x0007)  MISSED
};

/// Class /Script/AIModule.EnvQueryGenerator_SimpleGrid
/// Size: 0x0088 (136 bytes) (0x000088 - 0x000110) align 8 pad: 0x0000
...
public:
	...
	SDK_UNDEFINED(16,414) /* FMulticastInlineDelegate */ __um(OnQueryFinishedEvent);                               // 0x0070   (0x0010)  
	// void SetNamedParam(FName ParamName, float Value);                                                                        // [0x49ed570] Final|Native|Public|BlueprintCallable 
	// TArray<FVector> GetResultsAsLocations();                                                                                 // [0x49ed360] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// TArray<AActor*> GetResultsAsActors();                                                                                    // [0x49ed2e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// bool GetQueryResultsAsLocations(TArray<FVector>& ResultLocations);                                                       // [0x49ed220] Final|Native|Public|HasOutParms|BlueprintCallable|Const 
	// bool GetQueryResultsAsActors(TArray<AActor*>& ResultActors);                                                             // [0x49ed160] Final|Native|Public|HasOutParms|BlueprintCallable|Const 
	// float GetItemScore(int32_t ItemIndex);                                                                                   // [0x49ed0c0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// void EQSQueryDoneSignature__DelegateSignature(class UEnvQueryInstanceBlueprintWrapper* QueryInstance, TEnumAsByte<EEnvQueryStatus> QueryStatus); // [0x25a7960] MulticastDelegate|Public|Delegate 
};
...
/// Size: 0x0188 (392 bytes) (0x000000 - 0x000188) align 8 pad: 0x0000
struct FEnvQueryInstanceCache
{ 
	class UEnvQuery*                                   Template;                                                   // 0x0000   (0x0008)  
	unsigned char                                      UnknownData00_7[0x180];                                     // 0x0008   (0x0180)  MISSED
};

/// Class /Script/AIModule.EnvQueryManager
/// Size: 0x0108 (264 bytes) (0x000040 - 0x000148) align 8 pad: 0x0000
class UEnvQueryManager : public UAISubsystem
{ 
public:
	unsigned char                                      UnknownData00_3[0x70];                                      // 0x0040   (0x0070)  MISSED
	...
	// class UEnvQueryInstanceBlueprintWrapper* RunEQSQuery(class UObject* WorldContextObject, class UEnvQuery* QueryTemplate, class UObject* Querier, TEnumAsByte<EEnvQueryRunMode> RunMode, class UClass* WrapperClass); // [0x49ed3e0] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	unsigned char                                      UnknownData02_6[0x1];                                       // 0x0118   (0x0001)  MISSED
	TEnumAsByte<EEnvTestScoreEquation>                 ScoringEquation;                                            // 0x0119   (0x0001)  
	TEnumAsByte<EEnvQueryTestClamping>                 ClampMinType;                                               // 0x011A   (0x0001)  
	TEnumAsByte<EEnvQueryTestClamping>                 ClampMaxType;                                               // 0x011B   (0x0001)  
	...
	unsigned char                                      UnknownData04_6[0xF];                                       // 0x0221   (0x000F)  MISSED
	bool                                               bWorkOnFloatValues : 1;                                     // 0x0230:0 (0x0001)  
	unsigned char                                      UnknownData05_7[0x7];                                       // 0x0231   (0x0007)  MISSED
};

/// Class /Script/AIModule.EnvQueryTest_Distance
/// Size: 0x0010 (16 bytes) (0x000238 - 0x000248) align 8 pad: 0x0000
class UEnvQueryTest_Distance : public UEnvQueryTest
{ 
public:
	TEnumAsByte<EEnvTestDistance>                      TestMode;                                                   // 0x0238   (0x0001)  
...
/// Size: 0x0048 (72 bytes) (0x000238 - 0x000280) align 8 pad: 0x0000
...
public:
	...
	unsigned char                                      UnknownData00_7[0x6];                                       // 0x027A   (0x0006)  MISSED
};

/// Class /Script/AIModule.EnvQueryTest_GameplayTags
/// Size: 0x0070 (112 bytes) (0x000238 - 0x0002A8) align 8 pad: 0x0000
...
/// Size: 0x0098 (152 bytes) (0x000238 - 0x0002D0) align 8 pad: 0x0000
class UEnvQueryTest_Pathfinding : public UEnvQueryTest
{ 
public:
	TEnumAsByte<EEnvTestPathfinding>                   TestMode;                                                   // 0x0238   (0x0001)  
	unsigned char                                      UnknownData00_6[0x7];                                       // 0x0239   (0x0007)  MISSED
...
/// Size: 0x0040 (64 bytes) (0x0002D0 - 0x000310) align 8 pad: 0x0000
...
/// Size: 0x0030 (48 bytes) (0x000238 - 0x000268) align 8 pad: 0x0000
...
/// Size: 0x00F8 (248 bytes) (0x000238 - 0x000330) align 8 pad: 0x0000
...
/// Size: 0x0018 (24 bytes) (0x000238 - 0x000250) align 8 pad: 0x0000
...
public:
	...
	unsigned char                                      UnknownData00_7[0x7];                                       // 0x0249   (0x0007)  MISSED
};
...
/// Size: 0x00A0 (160 bytes) (0x0005A0 - 0x000640) align 16 pad: 0x0000
class AEQSTestingPawn : public ACharacter
{ 
public:
	class UEnvQuery*                                   QueryTemplate;                                              // 0x05A0   (0x0008)  
	TArray<FEnvNamedValue>                             QueryParams;                                                // 0x05A8   (0x0010)  
	TArray<FAIDynamicParam>                            QueryConfig;                                                // 0x05B8   (0x0010)  
	float                                              TimeLimitPerStep;                                           // 0x05C8   (0x0004)  
	int32_t                                            StepToDebugDraw;                                            // 0x05CC   (0x0004)  
	EEnvQueryHightlightMode                            HighlightMode;                                              // 0x05D0   (0x0001)  
	unsigned char                                      UnknownData00_6[0x3];                                       // 0x05D1   (0x0003)  MISSED
	bool                                               bDrawLabels : 1;                                            // 0x05D4:0 (0x0001)  
	bool                                               bDrawFailedItems : 1;                                       // 0x05D4:1 (0x0001)  
	bool                                               bReRunQueryOnlyOnFinishedMove : 1;                          // 0x05D4:2 (0x0001)  
	bool                                               bShouldBeVisibleInGame : 1;                                 // 0x05D4:3 (0x0001)  
	bool                                               bTickDuringGame : 1;                                        // 0x05D4:4 (0x0001)  
	unsigned char                                      UnknownData01_5[0x3];                                       // 0x05D5   (0x0003)  MISSED
	TEnumAsByte<EEnvQueryRunMode>                      QueryingMode;                                               // 0x05D8   (0x0001)  
	unsigned char                                      UnknownData02_6[0x7];                                       // 0x05D9   (0x0007)  MISSED
	FNavAgentProperties                                NavAgentProperties;                                         // 0x05E0   (0x0038)  
	unsigned char                                      UnknownData03_7[0x28];                                      // 0x0618   (0x0028)  MISSED
};
...
/// Size: 0x0030 (48 bytes) (0x000260 - 0x000290) align 8 pad: 0x0000
...
public:
	...
	TArray<FNavigationLink>                            PointLinks;                                                 // 0x02B8   (0x0010)  
	TArray<FNavigationSegmentLink>                     SegmentLinks;                                               // 0x02C8   (0x0010)  
	class UNavLinkCustomComponent*                     SmartLinkComp;                                              // 0x02D8   (0x0008)  
	bool                                               bSmartLinkIsRelevant;                                       // 0x02E0   (0x0001)  
	unsigned char                                      UnknownData01_6[0x7];                                       // 0x02E1   (0x0007)  MISSED
	SDK_UNDEFINED(16,415) /* FMulticastInlineDelegate */ __um(OnSmartLinkReached);                                 // 0x02E8   (0x0010)  
	// void SetSmartLinkEnabled(bool bEnabled);                                                                                 // [0x49f0f50] Final|Native|Public|BlueprintCallable 
	// void ResumePathFollowing(class AActor* Agent);                                                                           // [0x49f0c40] Final|Native|Public|BlueprintCallable 
	// void ReceiveSmartLinkReached(class AActor* Agent, FVector& Destination);                                                 // [0x25a7960] Event|Public|HasOutParms|HasDefaults|BlueprintEvent 
	// bool IsSmartLinkEnabled();                                                                                               // [0x49f0590] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// bool HasMovingAgents();                                                                                                  // [0x49f0560] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// bool SetLocalNavigationGridDensity(class UObject* WorldContextObject, float CellSize);                                   // [0x49f0cd0] Final|Native|Static|Public|BlueprintCallable 
	// void RemoveLocalNavigationGrid(class UObject* WorldContextObject, int32_t GridId, bool bRebuildGrids);                   // [0x49f0b40] Final|Native|Static|Public|BlueprintCallable 
	// bool FindLocalNavigationGridPath(class UObject* WorldContextObject, FVector& Start, FVector& End, TArray<FVector>& PathPoints); // [0x49f02c0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// int32_t AddLocalNavigationGridForPoints(class UObject* WorldContextObject, TArray<FVector>& Locations, int32_t Radius2D, float Height, bool bRebuildGrids); // [0x49f0010] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// int32_t AddLocalNavigationGridForPoint(class UObject* WorldContextObject, FVector& Location, int32_t Radius2D, float Height, bool bRebuildGrids); // [0x49efe50] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// int32_t AddLocalNavigationGridForCapsule(class UObject* WorldContextObject, FVector& Location, float CapsuleRadius, float CapsuleHalfHeight, int32_t Radius2D, float Height, bool bRebuildGrids); // [0x49efc30] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// int32_t AddLocalNavigationGridForBox(class UObject* WorldContextObject, FVector& Location, FVector Extent, FRotator Rotation, int32_t Radius2D, float Height, bool bRebuildGrids); // [0x49ef9f0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
public:
	...
	unsigned char                                      UnknownData01_7[0x17];                                      // 0x0089   (0x0017)  MISSED
	// TEnumAsByte<EAIRequestPriority> GetActionPriority();                                                                     // [0x49f04d0] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// void Finish(TEnumAsByte<EPawnActionResult> WithResult);                                                                  // [0x49f0450] Native|Protected|BlueprintCallable 
	// class UPawnAction* CreateActionInstance(class UObject* WorldContextObject, class UClass* ActionClass);                   // [0x49f01f0] Final|Native|Static|Public|BlueprintCallable 
};
...
{ 
public:
	// void ActionTick(class APawn* ControlledPawn, float DeltaSeconds);                                                        // [0x25a7960] Event|Public|BlueprintEvent 
	// void ActionStart(class APawn* ControlledPawn);                                                                           // [0x25a7960] Event|Public|BlueprintEvent 
	// void ActionResume(class APawn* ControlledPawn);                                                                          // [0x25a7960] Event|Public|BlueprintEvent 
	// void ActionPause(class APawn* ControlledPawn);                                                                           // [0x25a7960] Event|Public|BlueprintEvent 
	// void ActionFinished(class APawn* ControlledPawn, TEnumAsByte<EPawnActionResult> WithResult);                             // [0x25a7960] Event|Public|BlueprintEvent 
};
...
{ 
public:
	class AActor*                                      GoalActor;                                                  // 0x00A0   (0x0008)  
	FVector                                            GoalLocation;                                               // 0x00A8   (0x000C)  
	...
	bool                                               bAbortChildActionOnPathChange : 1;                          // 0x00C0:6 (0x0001)  
	unsigned char                                      UnknownData00_7[0x2F];                                      // 0x00C1   (0x002F)  MISSED
};
...
{ 
public:
	class UPawnAction*                                 ActionToRepeat;                                             // 0x00A0   (0x0008)  
	class UPawnAction*                                 RecentActionCopy;                                           // 0x00A8   (0x0008)  
	TEnumAsByte<EPawnActionFailHandling>               ChildFailureHandlingMode;                                   // 0x00B0   (0x0001)  
...
{ 
public:
	TArray<class UPawnAction*>                         ActionSequence;                                             // 0x00A0   (0x0010)  
	TEnumAsByte<EPawnActionFailHandling>               ChildFailureHandlingMode;                                   // 0x00B0   (0x0001)  
	unsigned char                                      UnknownData00_6[0x7];                                       // 0x00B1   (0x0007)  MISSED
	class UPawnAction*                                 RecentActionCopy;                                           // 0x00B8   (0x0008)  
...
{ 
public:
	float                                              TimeToWait;                                                 // 0x00A0   (0x0004)  
	unsigned char                                      UnknownData00_7[0xC];                                       // 0x00A4   (0x000C)  MISSED
};
...
public:
	...
	// bool K2_PushAction(class UPawnAction* NewAction, TEnumAsByte<EAIRequestPriority> Priority, class UObject* Instigator);   // [0x49f0800] Final|Native|Public|BlueprintCallable 
	// bool K2_PerformAction(class APawn* Pawn, class UPawnAction* Action, TEnumAsByte<EAIRequestPriority> Priority);           // [0x49f0700] Final|Native|Static|Public|BlueprintCallable 
	// TEnumAsByte<EPawnActionAbortState> K2_ForceAbortAction(class UPawnAction* ActionToAbort);                                // [0x49f0660] Final|Native|Public|BlueprintCallable 
	// TEnumAsByte<EPawnActionAbortState> K2_AbortAction(class UPawnAction* ActionToAbort);                                     // [0x49f05c0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	SDK_UNDEFINED(16,416) /* FMulticastInlineDelegate */ __um(OnSeePawn);                                          // 0x00E0   (0x0010)  
	SDK_UNDEFINED(16,417) /* FMulticastInlineDelegate */ __um(OnHearNoise);                                        // 0x00F0   (0x0010)  
	float                                              PeripheralVisionAngle;                                      // 0x0100   (0x0004)  
	float                                              PeripheralVisionCosine;                                     // 0x0104   (0x0004)  
	// void SetSensingUpdatesEnabled(bool bEnabled);                                                                            // [0x49f0ec0] BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// void SetSensingInterval(float NewSensingInterval);                                                                       // [0x49f0e30] BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// void SetPeripheralVisionAngle(float NewPeripheralVisionAngle);                                                           // [0x49f0da0] BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// void SeePawnDelegate__DelegateSignature(class APawn* Pawn);                                                              // [0x25a7960] MulticastDelegate|Public|Delegate 
	// void HearNoiseDelegate__DelegateSignature(class APawn* Instigator, FVector& Location, float Volume);                     // [0x25a7960] MulticastDelegate|Public|Delegate|HasOutParms|HasDefaults 
	// float GetPeripheralVisionCosine();                                                                                       // [0x365f5c0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// float GetPeripheralVisionAngle();                                                                                        // [0x365f6e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
{ 
	...
	unsigned char                                      UnknownData02_7[0x3];                                       // 0x0041   (0x0003)  MISSED
};
...
{ 
	...
	SDK_UNDEFINED(8,418) /* TWeakObjectPtr<AActor*> */ __um(Target);                                               // 0x0004   (0x0008)  
