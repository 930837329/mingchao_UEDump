...
enum class EMouseCursor : uint8_t
{
	...
	EMouseCursor__CursorPress                                                        = 15,
	EMouseCursor__CursorEnter                                                        = 16
};
...
/// Size: 0x0030 (48 bytes) (0x000000 - 0x000030) align n/a pad: 0x0000
class UObject
{ 
public:
	...
	class UObject*                                     OuterPrivate66666;                                          // 0x0020   (0x0008)  
	class UObject*                                     OuterPrivate;                                               // 0x0028   (0x0008)  
	// void ExecuteUbergraph(int32_t EntryPoint);                                                                               // [0x25a7960] Event|Public|BlueprintEvent 
};
...
/// Size: 0x0008 (8 bytes) (0x000030 - 0x000038) align n/a pad: 0x0000
class UField : public UObject
{ 
public:
	class UField*                                      Next;                                                       // 0x0030   (0x0008)  
};

/// Class /Script/CoreUObject.Struct
/// Size: 0x0080 (128 bytes) (0x000038 - 0x0000B8) align n/a pad: 0x0000
class UStruct : public UField
{ 
public:
	class UStruct*                                     SuperStruct;                                                // 0x0038   (0x0008)  
	class UField*                                      Children;                                                   // 0x0040   (0x0008)  
	unsigned char                                      UnknownData00_7[0x70];                                      // 0x0048   (0x0070)  MISSED
};

/// Class /Script/CoreUObject.Class
/// Size: 0x0188 (392 bytes) (0x0000B8 - 0x000240) align 8 pad: 0x0000
class UClass : public UStruct
{ 
public:
	unsigned char                                      UnknownData00_1[0x188];                                     // 0x00B8   (0x0188)  MISSED
};
...
{ 
public:
	unsigned char                                      UnknownData00_1[0x18];                                      // 0x00E8   (0x0018)  MISSED
};

/// Class /Script/CoreUObject.DynamicClass
/// Size: 0x0080 (128 bytes) (0x000240 - 0x0002C0) align 8 pad: 0x0000
class UDynamicClass : public UClass
{ 
public:
	unsigned char                                      UnknownData00_1[0x80];                                      // 0x0240   (0x0080)  MISSED
};
...
/// Size: 0x01B8 (440 bytes) (0x000240 - 0x0003F8) align 8 pad: 0x0000
class ULinkerPlaceholderClass : public UClass
{ 
public:
	unsigned char                                      UnknownData00_1[0x1B8];                                     // 0x0240   (0x01B8)  MISSED
};
...
{ 
public:
	unsigned char                                      UnknownData00_1[0xC8];                                      // 0x0030   (0x00C8)  MISSED
};

/// Class /Script/CoreUObject.LinkerPlaceholderFunction
/// Size: 0x01B8 (440 bytes) (0x0000E8 - 0x0002A0) align 8 pad: 0x0000
class ULinkerPlaceholderFunction : public UFunction
{ 
public:
	unsigned char                                      UnknownData00_1[0x1B8];                                     // 0x00E8   (0x01B8)  MISSED
};
...
{ 
	FPrimaryAssetId                                    BundleScope;                                                // 0x0000   (0x0018)  
	FName                                              BundleName;                                                 // 0x0018   (0x000C)  
	unsigned char                                      UnknownData00_6[0x4];                                       // 0x0024   (0x0004)  MISSED
	TArray<FSoftObjectPath>                            BundleAssets;                                               // 0x0028   (0x0010)  
};
...
{ 
	...
	unsigned char                                      UnknownData00_7[0x2C];                                      // 0x003C   (0x002C)  MISSED
};
