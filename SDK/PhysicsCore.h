...
public:
	...
	TEnumAsByte<EPhysicsType>                          PhysicsType;                                                // 0x003C   (0x0001)  
	TEnumAsByte<ECollisionTraceFlag>                   CollisionTraceFlag;                                         // 0x003D   (0x0001)  
	TEnumAsByte<EBodyCollisionResponse>                CollisionReponse;                                           // 0x003E   (0x0001)  
	bool                                               bOnlyUseSimpleCollision;                                    // 0x003F   (0x0001)  
...
public:
	float                                              Friction;                                                   // 0x0030   (0x0004)  
	float                                              StaticFriction;                                             // 0x0034   (0x0004)  
	TEnumAsByte<EFrictionCombineMode>                  FrictionCombineMode;                                        // 0x0038   (0x0001)  
	...
	TEnumAsByte<EFrictionCombineMode>                  RestitutionCombineMode;                                     // 0x0040   (0x0001)  
	...
	TEnumAsByte<EPhysicalSurface>                      SurfaceType;                                                // 0x0068   (0x0001)  
	unsigned char                                      UnknownData03_7[0x1F];                                      // 0x0069   (0x001F)  MISSED
};
...
public:
	...
	TEnumAsByte<EFrictionCombineMode>                  FrictionCombineMode;                                        // 0x006C   (0x0001)  
	TEnumAsByte<EFrictionCombineMode>                  RestitutionCombineMode;                                     // 0x006D   (0x0001)  
	...
	TEnumAsByte<ECollisionTraceFlag>                   DefaultShapeComplexity;                                     // 0x0085   (0x0001)  
